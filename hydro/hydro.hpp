...
class Hydro {
 ...
 public:
  ...
  // Added by Navin: Add flux and source
  Real add_flux_gas_time, add_source_gas_time;

  // Added by Navin
  // For computing heating
  int num_layer, magic_heating;
  Real dx, dy, dz;
  AthenaArray<int> layer_grid;
  AthenaArray<Real> xv, xf, yf, zf, layer_heat; 

  // Added by Navin
  // For computing mean density of each layer
  int num_grid_sum;
  Real x_start_sum, x_end_sum;
  AthenaArray<Real> mean_rho;
